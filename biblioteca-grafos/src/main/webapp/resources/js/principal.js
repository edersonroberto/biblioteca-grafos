...
sys.addEdge('a1', 'a4',{'color':'black', 'weight':8});
sys.addEdge('a2', 'a0',{'color':'black', 'weight':20});
sys.addEdge('a2', 'a3',{'color':'black', 'weight':12});
sys.addEdge('a2', 'a4',{'color':'black', 'weight':9});
sys.addEdge('a3', 'a0',{'color':'black', 'weight':14});
sys.addEdge('a3', 'a4',{'color':'black', 'weight':5});
sys.addEdge('a3', 'a5',{'color':'black', 'weight':6});
