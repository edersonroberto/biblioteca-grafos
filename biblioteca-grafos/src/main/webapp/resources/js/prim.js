...
sys.addEdge('a1', 'a2',{'color':'green','directed': true, 'weight':1});
sys.addEdge('a1', 'a3',{'color':'green','directed': true, 'weight':1});
sys.addEdge('a2', 'a0',{'color':'green','directed': true, 'weight':2});
sys.addEdge('a2', 'a3',{'color':'red','directed': true, 'weight':1});
sys.addEdge('a2', 'a4',{'color':'green','directed': true, 'weight':2});
sys.addEdge('a3', 'a0',{'color':'red','directed': true, 'weight':1});
sys.addEdge('a3', 'a4',{'color':'red','directed': true, 'weight':1});
